...
- Verify each feature (build clean, `ctest` green) before moving on.
...
```text
feat: add department and Erasmus account types
fix: reject overdrafts on withdraw
test: cover AM validation rules
